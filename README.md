...
radian-ops-deploy-meter is a JavaScript project for automation. It focuses on this technical goal: Develop a JavaScript command-oriented project for deploy scenarios with safe and unsafe fixtures, remediation hints, and single-node deterministic mode.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 169, risk penalty 5, latency penalty 3, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
