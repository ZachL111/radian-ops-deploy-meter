"""Regression checks for the radian-ops-deploy-meter casebook."""
...
from casebook.harness import assert_expected, radian_ops_deploy_meter_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(radian_ops_deploy_meter_summary(), assert_expected())
